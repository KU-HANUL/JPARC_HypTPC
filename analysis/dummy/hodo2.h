...
void hodo2::pipip(TFile *file, double ecut, bool window, double &acceptance, bool printout=false){
...
void hodo2::pipin(TFile *file, double ecut, bool window, double &acceptance, bool printout=false){
...
void hodo2::pipin2(TFile *file, double ecut, bool window, double &acceptance, bool printout=false){
  ...
  for(int i=0;i<nevent;i++){
    ...
    hist_multi[class_hodo] -> Fill(multiplicity); //Hodoscope multiplicity
    if(multiplicity==1){
      if(count_pi1==1 && count_pi2==1) count_m1_coin++;
